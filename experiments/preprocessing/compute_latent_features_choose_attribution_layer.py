...
def main(model_name,
    ...
    for i, neuron in enumerate(tqdm(np.arange(0, num_neurons))):
        ...
        for x, _ in dataloader:
            ...
            lower_gradient = attr.relevances[attribution_layer_name].detach().cpu()
            lower_activations = attr.activations[attribution_layer_name].detach().cpu()
    ...
    save_file({
        ...
        f"{path}/latent_features_{layer_name}_{split}_{attribution_layer_name}.safetensors")
...
if __name__ == "__main__":
    ...
    main(model_name, ckpt_path, dataset_name, data_path, split, batch_size, layer_name, attribution_layer_name)
